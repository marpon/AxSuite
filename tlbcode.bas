...
Sub putEvtList Cdecl Alias "putEvtList"(evt As String)Export
	EvtList &=evt & "|"
End Sub

Sub clrEvtList Cdecl Alias "clrEvtList"()Export
	EvtList=""
End Sub
...
Function EnumvTable cdecl Alias "EnumvTable"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
...
Function EnumInvoke cdecl Alias "EnumInvoke"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
	Dim hNextItem As Long
	Dim HasChilds As Long
...
Function EnumEvent cdecl Alias "EnumEvent"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
	Dim hNextItem As Long
	Dim HasChilds As Long
...
Function EnumEnum cdecl Alias "EnumEnum"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
	Dim hNextItem As Long
	Dim HasChilds As Long
...
Function EnumRecord cdecl Alias "EnumRecord"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
	Dim hNextItem As Long
	Dim HasChilds As Long
	Dim token As String
...
Function EnumUnion cdecl Alias "EnumUnion"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
	Dim hNextItem As Long
	Dim HasChilds As Long
	Dim token As String
...
Function EnumModule cdecl Alias "EnumModule"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
	Dim hNextItem As Long
	Dim HasChilds As Long
	Dim token As String,tldesc As String
...
Function EnumAlias cdecl Alias "EnumAlias"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
	Dim hNextItem As Long
	Dim HasChilds As Long
	Dim token As String
...
Function EnumCoClass cdecl Alias "EnumCoClass"(hTree As Long,hParent() As long)As zString Ptr Export  
	Dim Parents() As Long
	Dim hNextItem As Long
	Dim HasChilds As Long
