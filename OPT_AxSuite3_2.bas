...
_:[CSED_COMPIL_NAME]:   AxSuite3_2.exe  ' with ou without double quotes !
...
' Incorporated here : #Include once "inc_files.bi"
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
' START INCLUDE ¤ 001 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\inc_files.bi
...
#IFNDEF INCFILE_PLUS
   ...
   End Function
	...
	Private function StringImport_(TabU1 as ubyte ptr, IncFil_len As Uinteger, Newvar As String)as string
      dim x as integer
...
' FINISH INCLUDE ¤ 001 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\inc_files.bi
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
...
'=========================================================================
' Incorporated here : #Include Once "Ax_Utils.bi"                   ' axhelper + strwrap + lv + tv
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
' START INCLUDE ¤ 002 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\Ax_Utils.bi
...
'**********************************************************
Private Function str_parsepos(ByRef match As String, byref source As String, ByRef delimiter As String) As Integer
   Dim As Integer i
...
'************************************************************************
Private Function str_numparseany(ByRef source As String, Byref delimiter As String) As Long
   Dim As Long s = 1, c
   Do
...
'********************************************************************
Private Function str_parseany(ByRef source As String, Byref delimiter As String, ByVal idx As Long) As String
   Dim As Long s = 1, c
   Do
...
'find index of match string as parse source by delimiter
'**********************************************************
Private Function str_parseanypos(ByRef match As String, byref source As String, ByRef delimiter As String) As Integer
   Dim As Integer i
...
'**************************************************************
Private function str_tallyany(ByRef source as string, byref delimiter as string) as long
   Dim As Long s = 1, c
   Do
      s = InStr(s, source, any delimiter)
      If s then
...
'*****************************************************************
Private Function Str_replaceany(ByRef match As String, Byref sreplace As String, Byref source As String) As String
...
'replace all occurance of any character in del string with r string in cmd string
'*****************************************************************
Private Function str_ReplaceAnyAll(ByRef match As String, ByRef sreplace As String, ByRef source As String) As String
   Dim text As String
   text = source
...
Private Sub LVSetColFmt(BYVAL lvg AS uinteger, ByVal col As LONG, BYVAL fmt AS LONG)
   dim szItem AS zstring * MAX_PATH              ' working variable
   dim tlvc AS LVCOLUMN                          ' specifies or receives the attributes of a listview column
...
Private SUB LVSetMaxRows(BYVAL rr as uinteger, BYVAL rows AS LONG)
   dim irow AS LONG
   dim tlvi AS LVITEM
...
Private SUB LVSetValue(BYVAL rr AS uinteger, BYVAL item AS LONG, BYVAL column AS LONG, BYVAL strs AS STRING)
...
Private function lvFindItem(hList AS LONG, Value AS STRING) as integer
...
Private SUB LVSetItem(hList AS LONG, byval item as long, Rec AS STRING)
   DIM z AS INTEGER
   DIM iStatus AS INTEGER
   DIM szStr AS zstring* 300
   DIM lvi AS LV_ITEM
...
Private SUB LVAddItem(hList AS LONG, Rec AS STRING)
   DIM z AS INTEGER
   DIM iStatus AS INTEGER
   DIM szStr AS zstring* 300
   DIM lvi AS LV_ITEM
...
'false otherwise.
'---------------------------------------------------
Private Function IsTVItemChecked(hwndTV as Long, hItem as Long) as integer
	Dim tvi as TV_ITEM
	dim i1 as integer
...
' FINISH INCLUDE ¤ 002 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\Ax_Utils.bi
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
...
'=========================================================================
' Incorporated here : #Include Once "tlbcode1.bi"
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
' START INCLUDE ¤ 003 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\tlbcode1.bi
...
Private Function EnumCoClass2 (hTree As Long, hParent() As long) As String
   Dim Parents() As Long
...
Private Function EnumModule2 cdecl Alias "EnumModule2"(hTree As Long, hParent() As long) As zString Ptr
   Dim Parents() As Long
   Dim hNextItem As Long
   Dim HasChilds As Long
   Dim token As String, tldesc As String
...
' FINISH INCLUDE ¤ 003 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\tlbcode1.bi
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤

' Incorporated here : #Include Once "tlib1.bi"
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
' START INCLUDE ¤ 004 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\tlib1.bi
...
' FINISH INCLUDE ¤ 004 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\tlib1.bi
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤

' Incorporated here : #Include once "dlgMain1.bi"
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
' START INCLUDE ¤ 005 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\dlgMain1.bi
...
' FINISH INCLUDE ¤ 005 _ C:\Documents and Settings\Perso\Mes documents\axsuite2pkg\axsuite2pkg\AxSuite2\dlgMain1.bi
'¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
...
Private Function dlgAbout_OnSize(Byval hWin as hwnd, Byval lState as long, Byval cx as long, Byval cy as long) as Integer
   function = 0
End Function
